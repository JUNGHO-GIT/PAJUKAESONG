...
export const AuthPrivacy = () => {
  ...
  const authPrivacyNode = () => {
        ...
        <Grid container spacing={3} columns={12}>
          ...
          <Grid size={12}>
            ...
            <Div className={"fs-1-0rem fw-500"}>
              - This privacy policy applies to the PAJUKAESONG app (hereby referred to as "Application") for mobile devices that was created by JUNGHO (hereby referred to as "Service Provider") as a Free service. This service is intended for use "AS IS".
            </Div>
          </Grid>
          ...
          <Grid size={12}>
            ...
            <Div className={"fs-1-0rem fw-500 mb-20"}>
    ...
    // 7-10. return
    return (
      <Paper className={"content-wrapper radius border-1 h-100vh"}>
